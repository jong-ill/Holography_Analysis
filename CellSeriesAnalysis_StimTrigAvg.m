...
[ stimTrig{cellNum}.normDiff(1:tiffInfo.width,1:tiffInfo.height,:), stimTrig{cellNum}.Diff(1:tiffInfo.width,1:tiffInfo.height,:),stimTrig{cellNum}.PreStim(1:tiffInfo.width,1:tiffInfo.height,:),...
    stimTrig{cellNum}.PostStim(1:tiffInfo.width,1:tiffInfo.height,:)] = DiffAvgFigsLongMeasurements( m, StackAll ,frameidxtemp ,prefigs ,postfigs,Omitpost );
end
StackAll = [];
...
subtightplot(2,max(1,(numCells/2)),cellPlot,[0.001,0.001])
